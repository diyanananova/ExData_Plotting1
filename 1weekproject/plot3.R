...
plot3 <- plot(data_chars_as_num$Data_Time, data_chars_as_num$Sub_metering_1, type = "l", col = "black",  ylab = "Energy sub metering", xlab = "",) # Plot with Base R
...
legend("topright", c("Sub metering 1", "Submetering 2", "Submetering 3"), fill = mycols)
dev.off()
